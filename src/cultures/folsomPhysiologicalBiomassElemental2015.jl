...
#                 "unit" => "mM",
#                 "val" => [conc, conc, conc, conc],
#                 "errs" => [0.0, 0.0, 0.0, 0.0],
#             )
#         end
#         # Fe [μM] * 1e-3 = Fe [mM]
#         api[culid]["c_Fe"]["val"] .*= 1e-3
#     end
...
#         "unit" => "gCDW L^{-1}",
#         "val" => Y_Xglc4["val"] .* MM_glc .* c_glc["val"] .* 1e-3,
#     )
#     Xs_C = api["C_Limited"]["X"]
#     api["C_Limited"]["X"]["errs"] = Xs_C["val"] .* Xs2errs ./ Xs2
...
#         api[culid]["q_glc"] = Dict(
#             "unit" => "mmol gCDW^{-1} h^{-1}",
#             "val" => cul["data"]["raw"]["Supp2"][culid]["q_glc"]["val"] ./ 6.0,
...
#         api[culid]["q_o2"] = Dict(
#             "unit" => "mmol gCDW^{-1} h^{-1}",
#             "val" => cul["data"]["raw"]["Supp2"][culid]["q_o2"]["val"],
...
#         Ds = raw["Fig1"]["B"]["xval"]
#         Y_XNs = raw["Fig1"]["B"]["yval"][culid]
#         Y_XNerrs = raw["Fig1"]["B"]["yerr"][culid]
#         api[culid]["q_nh4"] = Dict(
#             "unit" => "mmol gCDW^{-1} h^{-1}", 
#             "val" => Ds ./ Y_XNs,
#             "errs" => Y_XNerrs .* Ds ./ Y_XNs.^2,
#         )
...
#         "unit" => "mmol gCDW^{-1} h^{-1}",
#         "val" => c_nh4["val"] .* api["N_Limited"]["D"]["val"] ./ api["N_Limited"]["X"]["val"],
#         "errs" => c_nh4["val"] .* api["N_Limited"]["D"]["val"] .* api["N_Limited"]["X"]["errs"] ./ api["N_Limited"]["X"]["val"],
#     )
